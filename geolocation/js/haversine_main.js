...
elLocate.addEventListener("click", function(){
    if(navigator.geolocation){
        navigator.geolocation.getCurrentPosition(function(position){
            ...
            let elDpulze = document.getElementById("dpluze")
            ...
            elDpulze.innerHTML = "Distance to Dpulze is " + distances[0] + "km"
            elKlcc.innerHTML = "Distance to Klcc is " + distances[2] + "km"
            elSunway.innerHTML = "Distance to Sunway is " + distances[1] + "km"
        })
